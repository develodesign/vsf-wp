  ...
  <div class="blog-page blog-page-posts-show">
    ...
    <div v-if="post">
      ...
      <div class="container">
        ...
        <div class="blog-page--preview-large blog-page--preview-large-hero-merge" :style="getPostImage(post)" >&nbsp;</div>
      ...
      <div class="blog-page--post-container">
        ...
        <div class="container">
          ...
          <router-link :to="localizedRoute(`/posts`)" class="link blog-page--preview-link">
            Back to posts
          </router-link>
